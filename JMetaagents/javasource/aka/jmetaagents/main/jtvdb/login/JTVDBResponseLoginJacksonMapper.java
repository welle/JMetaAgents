 ...
 * @author Charlotte
 */ 
public final class JTVDBResponseLoginJacksonMapper {
     ...
     */
	@Nullable
    public static JTVDBResponseLogin readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTVDBResponseLogin result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVDBResponseLogin.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVDBResponseLogin object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
