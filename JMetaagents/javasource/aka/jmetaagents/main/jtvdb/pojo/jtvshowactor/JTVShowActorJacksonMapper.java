 ...
 * @author Charlotte
 */ 
public final class JTVShowActorJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowActor readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowActor.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowActor object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
