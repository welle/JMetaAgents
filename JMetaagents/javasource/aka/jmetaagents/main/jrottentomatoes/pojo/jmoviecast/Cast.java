...
import aka.jmetaagents.main.jrottentomatoes.pojo.jmoviecast.deserializers.DateYearDeserializer;
...
public final class Cast {
     ...
     * @param idParam Date
     */
    public Cast(@NonNull final List<String> charactersParam, @Nullable final String nameParam, @Nullable final Date idParam) {
