 ...
 * @author Charlotte
 */
public final class JMovieAliasJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieAlias readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieAlias.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieAlias object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
