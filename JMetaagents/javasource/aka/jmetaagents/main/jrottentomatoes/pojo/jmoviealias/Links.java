...
import aka.jmetaagents.main.jrottentomatoes.pojo.jmoviealias.deserializers.URLDeserializer;
...
public final class Links {
     ...
     * @param canonicalParam URI
     */
    public Links(@Nullable final URI castParam, @Nullable final URI similarParam, @Nullable final URI reviewsParam, @Nullable final URI selfParam, @Nullable final URI alternateParam, @Nullable final URI canonicalParam) {
        this.cast = castParam;
        this.similar = similarParam;
        this.reviews = reviewsParam;
        this.self = selfParam;
        this.alternate = alternateParam;
        this.canonical = canonicalParam;
    }
    ...
    /**
     * Get value of canonical.
     *
     * @return URI value of canonical
     */
    @Nullable
    public final URI getCanonical() {
     ...
     */
    public final void setCanonical(@Nullable final URI canonicalParam) {
        this.canonical = canonicalParam;
    }
}
