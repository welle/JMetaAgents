 ...
 * @author Charlotte
 */
public final class JFilmographyJacksonMapper {
     ...
     */
    @Nullable
    public static JFilmography readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JFilmography.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JFilmography object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
