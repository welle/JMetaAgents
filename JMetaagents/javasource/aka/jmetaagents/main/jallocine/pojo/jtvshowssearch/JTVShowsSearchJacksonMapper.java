 ...
 * @author Charlotte
 */
public final class JTVShowsSearchJacksonMapper {
     ...
     */
    @Nullable
    public static JTVShowsSearch readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowsSearch.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JTVShowsSearch object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
