...
public final class WorstPressReview {
     ...
     */
    public WorstPressReview(@Nullable final NewsSource newsSourceParam, @Nullable final Integer codeParam, @Nullable final String authorParam, @Nullable final Double ratingParam, @Nullable final String creationDateParam, @Nullable final String bodyParam) {
