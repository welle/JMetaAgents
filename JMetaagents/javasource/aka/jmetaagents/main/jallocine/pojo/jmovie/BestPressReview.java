...
public final class BestPressReview {
     ...
     * @param authorParam String
     * @param ratingParam Double
     * @param newsSource1Param NewsSource1
     * @param creationDateParam String
     * @param bodyParam String
     */
    public BestPressReview(@Nullable final Integer codeParam, @Nullable final String authorParam, @Nullable final Double ratingParam, @Nullable final NewsSource1 newsSource1Param, @Nullable final String creationDateParam, @Nullable final String bodyParam) {
        this.code = codeParam;
     ...
     * @param authorParam
     */
    public final void setAuthor(@Nullable final String authorParam) {
        this.author = authorParam;
    }
