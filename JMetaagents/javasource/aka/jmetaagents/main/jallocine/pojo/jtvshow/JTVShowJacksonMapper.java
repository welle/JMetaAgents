 ...
 * @author Charlotte
 */
public final class JTVShowJacksonMapper {
     ...
     */
    @Nullable
    public static JTVShow readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTVShow result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShow.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JTVShow object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
