 ...
 * @author Charlotte
 */
public final class JPersonJacksonMapper {
     ...
     */
    @Nullable
    public static JPerson readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JPerson result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JPerson.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JPerson object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
