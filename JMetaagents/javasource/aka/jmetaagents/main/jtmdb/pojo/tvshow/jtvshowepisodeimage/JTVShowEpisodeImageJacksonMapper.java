 ...
 * @author Charlotte
 */ 
public final class JTVShowEpisodeImageJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowEpisodeImage readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowEpisodeImage.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowEpisodeImage object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
