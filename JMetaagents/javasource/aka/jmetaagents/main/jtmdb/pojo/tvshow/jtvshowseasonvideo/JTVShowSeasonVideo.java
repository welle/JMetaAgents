...
public final class JTVShowSeasonVideo {
     ...
     */
    public JTVShowSeasonVideo(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
