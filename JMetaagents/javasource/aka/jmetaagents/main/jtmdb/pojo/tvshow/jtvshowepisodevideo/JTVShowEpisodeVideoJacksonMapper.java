package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowepisodevideo;
 ...
 * @author Charlotte
 */ 
public final class JTVShowEpisodeVideoJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowEpisodeVideo readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowEpisodeVideo.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowEpisodeVideo object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
