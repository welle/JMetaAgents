 ...
 * @author Charlotte
 */ 
public final class JTVShowCreditsJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowCredits readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowCredits.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowCredits object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
