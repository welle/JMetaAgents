...
public final class JTVShowEpisodeVideo {
     ...
     */
    public JTVShowEpisodeVideo(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
