package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowimage;
 ...
 * @author Charlotte
 */ 
public final class JTVShowImageJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowImage readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowImage.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowImage object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
