package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowpopular;
 ...
 * @author Charlotte
 */ 
public final class JTVShowPopularJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowPopular readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowPopular.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowPopular object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
