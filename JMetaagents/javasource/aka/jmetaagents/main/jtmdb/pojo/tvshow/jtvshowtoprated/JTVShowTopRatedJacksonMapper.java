package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowtoprated;
 ...
 * @author Charlotte
 */ 
public final class JTVShowTopRatedJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowTopRated readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowTopRated.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowTopRated object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
