 ...
 * @author Charlotte
 */ 
public final class JTVShowSeasonVideoJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowSeasonVideo readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowSeasonVideo.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowSeasonVideo object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
