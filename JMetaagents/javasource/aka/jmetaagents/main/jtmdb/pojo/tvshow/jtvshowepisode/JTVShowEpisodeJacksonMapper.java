package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowepisode;
 ...
 * @author Charlotte
 */ 
public final class JTVShowEpisodeJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowEpisode readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowEpisode.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowEpisode object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
