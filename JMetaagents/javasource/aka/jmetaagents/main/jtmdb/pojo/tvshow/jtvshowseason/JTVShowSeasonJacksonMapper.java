 ...
 * @author Charlotte
 */ 
public final class JTVShowSeasonJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowSeason readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowSeason.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowSeason object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
