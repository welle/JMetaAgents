package aka.jmetaagents.main.jtmdb.pojo.tvshow.jtvshowvideo;
 ...
 * @author Charlotte
 */ 
public final class JTVShowVideoJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowVideo readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowVideo.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowVideo object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
