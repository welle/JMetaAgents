 ...
 * @author Charlotte
 */
public final class JCollectionImageJacksonMapper {
     ...
     */
    @Nullable
    public static JCollectionImage readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionImage.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JCollectionImage object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
