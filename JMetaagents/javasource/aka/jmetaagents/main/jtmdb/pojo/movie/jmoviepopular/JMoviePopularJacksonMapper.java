package aka.jmetaagents.main.jtmdb.pojo.movie.jmoviepopular;
 ...
 * @author Charlotte
 */
public final class JMoviePopularJacksonMapper {
     ...
     */
    @Nullable
    public static JMoviePopular readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviePopular.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMoviePopular object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
