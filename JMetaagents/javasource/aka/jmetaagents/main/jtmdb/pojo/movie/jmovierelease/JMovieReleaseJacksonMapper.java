 ...
 * @author Charlotte
 */
public final class JMovieReleaseJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieRelease readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieRelease.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieRelease object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
