package aka.jmetaagents.main.jtmdb.pojo.movie.jmoviesearch;
 ...
 * @author Charlotte
 */
public final class JMovieSearchJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieSearch readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieSearch.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieSearch object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
