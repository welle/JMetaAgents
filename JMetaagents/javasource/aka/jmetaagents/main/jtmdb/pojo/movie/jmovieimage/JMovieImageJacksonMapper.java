package aka.jmetaagents.main.jtmdb.pojo.movie.jmovieimage;
 ...
 * @author Charlotte
 */
public final class JMovieImageJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieImage readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieImage.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieImage object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
