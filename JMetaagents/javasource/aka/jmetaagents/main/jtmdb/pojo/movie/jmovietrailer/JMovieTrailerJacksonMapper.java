 ...
 * @author Charlotte
 */
public final class JMovieTrailerJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieTrailer readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieTrailer.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieTrailer object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
