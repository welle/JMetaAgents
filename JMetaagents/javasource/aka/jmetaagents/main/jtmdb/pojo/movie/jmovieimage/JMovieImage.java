...
public final class JMovieImage {
     ...
     */
    public JMovieImage(@NonNull final List<Backdrops> backdropsParam, @NonNull final List<Posters> postersParam, @Nullable final Integer idParam) {
