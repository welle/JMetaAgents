package aka.jmetaagents.main.jtmdb.pojo.movie.jmoviesimilar;
 ...
 * @author Charlotte
 */
public final class JMovieSimilarJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieSimilar readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieSimilar.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieSimilar object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
