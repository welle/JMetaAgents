...
public final class JMovieTopRated {
     ...
     */
    public JMovieTopRated(@Nullable final Integer pageParam, @Nullable final Integer totalPagesParam, @NonNull final List<Results> resultsParam, @Nullable final Integer totalResultsParam) {
        this.page = pageParam;
