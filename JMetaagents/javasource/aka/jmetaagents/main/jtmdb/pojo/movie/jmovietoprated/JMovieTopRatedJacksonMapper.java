package aka.jmetaagents.main.jtmdb.pojo.movie.jmovietoprated;
 ...
 * @author Charlotte
 */
public final class JMovieTopRatedJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieTopRated readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieTopRated.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieTopRated object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
