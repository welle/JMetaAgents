 ...
 * @author Charlotte
 */
public final class JMovieVideoJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieVideo readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieVideo.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieVideo object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
