 ...
 * @author Charlotte
 */
public final class JMovieJacksonMapper {
     ...
     */
    @Nullable
    public static JMovie readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMovie result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovie.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovie object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
