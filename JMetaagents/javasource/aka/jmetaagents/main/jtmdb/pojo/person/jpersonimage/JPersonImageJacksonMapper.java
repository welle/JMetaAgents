 ...
 * @author Charlotte
 */
public final class JPersonImageJacksonMapper {
     ...
     */
    @Nullable
    public static JPersonImage readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JPersonImage.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JPersonImage object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
