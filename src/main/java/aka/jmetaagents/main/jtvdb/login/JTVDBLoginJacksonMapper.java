 ...
 * @author Charlotte
 */
public final class JTVDBLoginJacksonMapper {
     ...
     */
    @Nullable
    public static JTVDBLogin readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTVDBLogin result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVDBLogin.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JTVDBLogin object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
