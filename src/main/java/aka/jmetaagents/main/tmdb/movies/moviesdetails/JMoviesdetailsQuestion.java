...
public final class JMoviesdetailsQuestion {
     ...
     */
    public JMoviesdetailsQuestion(@Nullable final String languageParam, @Nullable final Integer movieIdParam) {
