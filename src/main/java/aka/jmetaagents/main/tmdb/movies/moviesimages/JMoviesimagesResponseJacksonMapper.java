 ...
 * @author Welle
 */ 
public final class JMoviesimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
