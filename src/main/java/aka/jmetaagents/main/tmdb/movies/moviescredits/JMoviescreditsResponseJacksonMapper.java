 ...
 * @author Welle
 */ 
public final class JMoviescreditsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviescreditsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviescreditsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviescreditsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
