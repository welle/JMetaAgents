 ...
 * @author Welle
 */ 
public final class JMoviessimilarResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviessimilarResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviessimilarResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviessimilarResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
