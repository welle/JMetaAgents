 ...
 * @author Welle
 */ 
public final class JMoviesexternalidsQuestionJacksonMapper {
     ...
     * @return JMoviesexternalidsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JMoviesexternalidsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviesexternalidsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesexternalidsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesexternalidsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
