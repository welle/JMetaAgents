 ...
 * @author Welle
 */ 
public final class JMoviesrecommandationsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesrecommandationsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesrecommandationsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesrecommandationsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
