...
public final class JMoviestranslationsResponse {
     ...
     * Empty Constructor.
     */
    public JMoviestranslationsResponse() {
    	// Nothing to do
    }
     ...
     */
    public JMoviestranslationsResponse(@NonNull final List<Translations> translationsParam, @Nullable final Integer idParam) {
