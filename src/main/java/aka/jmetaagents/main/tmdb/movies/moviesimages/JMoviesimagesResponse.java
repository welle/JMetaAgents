...
public final class JMoviesimagesResponse {
     ...
     */
    public JMoviesimagesResponse(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
