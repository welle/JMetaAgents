...
import aka.jmetaagents.main.tmdb.movies.moviesdetails.deserializers.DateYearMonthDayDashDeserializer;
...
public final class JMoviesdetailsResponse {
     ...
     *
     * @return String value of belongsToCollection
     */
    @Nullable
    public final String getBelongsToCollection() {
     ...
     */
    public final void setProductionCountries(@NonNull final List<ProductionCountries> productionCountriesParam) {
        this.productionCountries = productionCountriesParam;
    }
     ...
     */
    public final void setSpokenLanguages(@NonNull final List<SpokenLanguages> spokenLanguagesParam) {
        this.spokenLanguages = spokenLanguagesParam;
    }
     ...
     */
    public final void setProductionCompanies(@NonNull final List<ProductionCompanies> productionCompaniesParam) {
        this.productionCompanies = productionCompaniesParam;
    }
     ...
     */
    public final void setBelongsToCollection(@Nullable final String belongsToCollectionParam) {
        this.belongsToCollection = belongsToCollectionParam;
    }
