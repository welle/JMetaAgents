 ...
 * @author Welle
 */ 
public final class JMoviesexternalidsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesexternalidsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesexternalidsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesexternalidsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
