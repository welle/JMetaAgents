 ...
 * @author Welle
 */ 
public final class JMoviesvideosResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesvideosResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesvideosResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesvideosResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
