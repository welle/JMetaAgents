 ...
 * @author Welle
 */ 
public final class JMoviesdetailsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesdetailsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesdetailsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesdetailsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
