...
public final class JMoviesimagesQuestion {
     ...
     */
    public JMoviesimagesQuestion(@Nullable final String languageParam, @Nullable final Integer movieIdParam) {
