...
public final class JMoviesvideosResponse {
     ...
     */
    public JMoviesvideosResponse(@NonNull final List<Backdrops> backdropsParam, @NonNull final List<Posters> postersParam, @Nullable final Integer idParam) {
