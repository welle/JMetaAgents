...
public final class Posters {
     ...
     */
    public Posters(@Nullable final Double aspectRatioParam, @Nullable final String filePathParam, @Nullable final Integer voteAverageParam, @Nullable final Integer widthParam, @Nullable final String iso6391Param, @Nullable final Integer voteCountParam, @Nullable final Integer heightParam) {
