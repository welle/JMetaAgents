...
public final class JMoviessimilarResponse {
     ...
     */
    public JMoviessimilarResponse(@Nullable final Integer pageParam, @Nullable final Integer totalPagesParam, @NonNull final List<Results> resultsParam, @Nullable final Integer totalResultsParam) {
        this.page = pageParam;
