 ...
 * @author Welle
 */ 
public final class JMoviessimilarQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviessimilarQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviessimilarQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviessimilarQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviessimilarQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
