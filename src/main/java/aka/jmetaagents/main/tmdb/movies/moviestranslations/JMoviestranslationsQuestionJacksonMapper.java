 ...
 * @author Welle
 */ 
public final class JMoviestranslationsQuestionJacksonMapper {
     ...
     * @return JMoviestranslationsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JMoviestranslationsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviestranslationsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviestranslationsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviestranslationsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
