 ...
 * @author Welle
 */ 
public final class JMoviesrecommandationsQuestionJacksonMapper {
     ...
     * @return JMoviesrecommandationsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JMoviesrecommandationsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviesrecommandationsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesrecommandationsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesrecommandationsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
