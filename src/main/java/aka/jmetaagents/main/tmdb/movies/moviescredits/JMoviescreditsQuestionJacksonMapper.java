 ...
 * @author Welle
 */ 
public final class JMoviescreditsQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviescreditsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviescreditsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviescreditsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviescreditsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
