 ...
 * @author Welle
 */ 
public final class JMoviesalternativetitlesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviesalternativetitlesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviesalternativetitlesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviesalternativetitlesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
