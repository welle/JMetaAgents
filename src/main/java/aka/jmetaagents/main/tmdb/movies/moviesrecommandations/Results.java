...
import aka.jmetaagents.main.tmdb.movies.moviesrecommandations.deserializers.DateYearMonthDayDashDeserializer;
...
public final class Results {
     ...
     */
    public Results(@Nullable final String overviewParam, @Nullable final String originalLanguageParam, @Nullable final String originalTitleParam, @Nullable final Boolean videoParam, @Nullable final String titleParam, @NonNull final List<String> genreIdsParam, @Nullable final String posterPathParam, @Nullable final String backdropPathParam, @Nullable final Date releaseDateParam, @Nullable final Double popularityParam, @Nullable final Integer voteAverageParam, @Nullable final Integer idParam, @Nullable final Boolean adultParam, @Nullable final Integer voteCountParam) {
     ...
     * @param genreIdsParam
     */
    public final void setGenreIds(@NonNull final List<String> genreIdsParam) {
        this.genreIds = genreIdsParam;
    }
