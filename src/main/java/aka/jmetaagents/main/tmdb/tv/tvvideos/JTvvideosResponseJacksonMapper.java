 ...
 * @author Welle
 */ 
public final class JTvvideosResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvvideosResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvvideosResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvvideosResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
