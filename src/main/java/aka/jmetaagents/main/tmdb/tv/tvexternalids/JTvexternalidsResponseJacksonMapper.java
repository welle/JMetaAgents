 ...
 * @author Welle
 */ 
public final class JTvexternalidsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvexternalidsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvexternalidsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvexternalidsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
