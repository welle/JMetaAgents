 ...
 * @author Welle
 */ 
public final class JTvimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
