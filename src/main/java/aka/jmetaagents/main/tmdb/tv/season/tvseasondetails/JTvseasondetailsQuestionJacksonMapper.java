 ...
 * @author Welle
 */ 
public final class JTvseasondetailsQuestionJacksonMapper {
     ...
     * @return JTvseasondetailsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvseasondetailsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvseasondetailsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasondetailsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasondetailsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
