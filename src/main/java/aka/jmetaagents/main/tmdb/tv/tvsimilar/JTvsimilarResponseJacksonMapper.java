 ...
 * @author Welle
 */ 
public final class JTvsimilarResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvsimilarResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvsimilarResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvsimilarResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
