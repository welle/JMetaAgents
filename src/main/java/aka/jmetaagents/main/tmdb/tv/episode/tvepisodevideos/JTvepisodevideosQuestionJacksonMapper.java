 ...
 * @author Welle
 */ 
public final class JTvepisodevideosQuestionJacksonMapper {
     ...
     * @return JTvepisodevideosQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvepisodevideosQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvepisodevideosQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodevideosQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodevideosQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
