 ...
 * @author Welle
 */ 
public final class JTvalternativetitlesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvalternativetitlesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvalternativetitlesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvalternativetitlesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
