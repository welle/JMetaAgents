 ...
 * @author Welle
 */ 
public final class JTvimagesQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JTvimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
