...
public final class JTvtranslationsQuestion {
     ...
     * Empty Constructor.
     */
    public JTvtranslationsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvtranslationsQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
