...
public final class JTvepisodeexternalidsQuestion {
     ...
     * Empty Constructor.
     */
    public JTvepisodeexternalidsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvepisodeexternalidsQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer episodeNumberParam, @Nullable final Integer seasonNumberParam) {
        this.tvId = tvIdParam;
