 ...
 * @author Welle
 */ 
public final class JTvseasonexternalidsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvseasonexternalidsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonexternalidsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonexternalidsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
