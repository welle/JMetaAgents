 ...
 * @author Welle
 */ 
public final class JTvseasondetailsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvseasondetailsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasondetailsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasondetailsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
