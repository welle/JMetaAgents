...
public final class JTvvideosQuestion {
     ...
     */
    public JTvvideosQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
