 ...
 * @author Welle
 */ 
public final class JTvcreditsQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JTvcreditsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvcreditsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvcreditsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvcreditsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
