...
public final class JTvseasoncreditsQuestion {
     ...
     * Empty Constructor.
     */
    public JTvseasoncreditsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvseasoncreditsQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer seasonNumberParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
