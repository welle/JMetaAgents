...
public final class JTvseasondetailsQuestion {
     ...
     * Empty Constructor.
     */
    public JTvseasondetailsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvseasondetailsQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer seasonNumberParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
