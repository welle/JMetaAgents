 ...
 * @author Welle
 */ 
public final class JTvseasonexternalidsQuestionJacksonMapper {
     ...
     * @return JTvseasonexternalidsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvseasonexternalidsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvseasonexternalidsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonexternalidsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonexternalidsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
