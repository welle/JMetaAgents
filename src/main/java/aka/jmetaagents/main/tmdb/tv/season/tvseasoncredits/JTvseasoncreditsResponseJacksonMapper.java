 ...
 * @author Welle
 */ 
public final class JTvseasoncreditsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvseasoncreditsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasoncreditsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasoncreditsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
