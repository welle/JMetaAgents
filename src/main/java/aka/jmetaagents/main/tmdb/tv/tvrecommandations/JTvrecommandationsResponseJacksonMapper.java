 ...
 * @author Welle
 */ 
public final class JTvrecommandationsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvrecommandationsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvrecommandationsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvrecommandationsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
