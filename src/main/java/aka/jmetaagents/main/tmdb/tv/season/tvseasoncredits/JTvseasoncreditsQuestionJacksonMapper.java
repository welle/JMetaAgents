 ...
 * @author Welle
 */ 
public final class JTvseasoncreditsQuestionJacksonMapper {
     ...
     * @return JTvseasoncreditsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvseasoncreditsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvseasoncreditsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasoncreditsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasoncreditsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
