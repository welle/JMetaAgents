...
public final class JTvvideosResponse {
     ...
     */
    public JTvvideosResponse(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
