...
public final class GuestStars {
     ...
     */
    public GuestStars(@Nullable final String characterParam, @Nullable final String genderParam, @Nullable final String creditIdParam, @Nullable final String nameParam, @Nullable final String profilePathParam, @Nullable final Integer idParam, @Nullable final Integer orderParam) {
