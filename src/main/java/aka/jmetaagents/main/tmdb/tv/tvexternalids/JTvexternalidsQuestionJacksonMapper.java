 ...
 * @author Welle
 */ 
public final class JTvexternalidsQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JTvexternalidsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvexternalidsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvexternalidsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvexternalidsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
