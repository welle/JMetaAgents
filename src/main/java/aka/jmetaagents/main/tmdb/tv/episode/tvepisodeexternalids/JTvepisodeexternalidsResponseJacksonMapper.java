 ...
 * @author Welle
 */ 
public final class JTvepisodeexternalidsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvepisodeexternalidsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodeexternalidsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodeexternalidsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
