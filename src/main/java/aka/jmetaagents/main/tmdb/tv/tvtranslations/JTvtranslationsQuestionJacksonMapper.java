 ...
 * @author Welle
 */ 
public final class JTvtranslationsQuestionJacksonMapper {
     ...
     * @return JTvtranslationsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvtranslationsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvtranslationsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvtranslationsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvtranslationsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
