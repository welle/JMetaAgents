 ...
 * @author Welle
 */ 
public final class JTvrecommandationsQuestionJacksonMapper {
     ...
     * @return JTvrecommandationsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvrecommandationsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvrecommandationsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvrecommandationsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvrecommandationsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
