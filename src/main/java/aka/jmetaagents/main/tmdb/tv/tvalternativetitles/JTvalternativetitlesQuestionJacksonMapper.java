 ...
 * @author Welle
 */ 
public final class JTvalternativetitlesQuestionJacksonMapper {
     ...
     * @return JTvalternativetitlesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvalternativetitlesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvalternativetitlesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvalternativetitlesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvalternativetitlesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
