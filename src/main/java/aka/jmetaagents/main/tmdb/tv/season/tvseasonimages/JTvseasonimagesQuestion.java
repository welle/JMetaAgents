...
public final class JTvseasonimagesQuestion {
     ...
     * Empty Constructor.
     */
    public JTvseasonimagesQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvseasonimagesQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer seasonNumberParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
