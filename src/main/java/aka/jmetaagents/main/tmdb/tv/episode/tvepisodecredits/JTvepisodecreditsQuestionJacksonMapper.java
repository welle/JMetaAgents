 ...
 * @author Welle
 */ 
public final class JTvepisodecreditsQuestionJacksonMapper {
     ...
     * @return JTvepisodecreditsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvepisodecreditsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvepisodecreditsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodecreditsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodecreditsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
