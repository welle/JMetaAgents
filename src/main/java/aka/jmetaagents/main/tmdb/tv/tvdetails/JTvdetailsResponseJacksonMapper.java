 ...
 * @author Welle
 */ 
public final class JTvdetailsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvdetailsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvdetailsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvdetailsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
