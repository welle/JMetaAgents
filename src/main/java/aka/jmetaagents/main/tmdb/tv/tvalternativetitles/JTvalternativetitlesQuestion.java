...
public final class JTvalternativetitlesQuestion {
     ...
     * Empty Constructor.
     */
    public JTvalternativetitlesQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvalternativetitlesQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
