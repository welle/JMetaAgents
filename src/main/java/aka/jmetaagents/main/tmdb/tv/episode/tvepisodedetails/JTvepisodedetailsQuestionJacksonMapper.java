 ...
 * @author Welle
 */ 
public final class JTvepisodedetailsQuestionJacksonMapper {
     ...
     * @return JTvepisodedetailsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvepisodedetailsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvepisodedetailsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodedetailsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodedetailsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
