 ...
 * @author Welle
 */ 
public final class JTvepisodeimagesQuestionJacksonMapper {
     ...
     * @return JTvepisodeimagesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvepisodeimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvepisodeimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodeimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodeimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
