 ...
 * @author Welle
 */ 
public final class JTvseasonvideosQuestionJacksonMapper {
     ...
     * @return JTvseasonvideosQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvseasonvideosQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvseasonvideosQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonvideosQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonvideosQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
