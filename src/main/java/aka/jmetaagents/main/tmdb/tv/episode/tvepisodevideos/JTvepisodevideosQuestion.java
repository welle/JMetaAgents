...
public final class JTvepisodevideosQuestion {
     ...
     * Empty Constructor.
     */
    public JTvepisodevideosQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvepisodevideosQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer episodeNumberParam, @Nullable final Integer seasonNumberParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
