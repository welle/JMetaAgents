...
import aka.jmetaagents.main.tmdb.tv.tvdetails.deserializers.DateYearMonthDayDashDeserializer;
import aka.jmetaagents.main.tmdb.tv.tvdetails.deserializers.URLDeserializer;
...
public final class JTvdetailsResponse {
     ...
     * @param networksParam
     */
    public final void setNetworks(@NonNull final List<Networks> networksParam) {
        this.networks = networksParam;
    }
     ...
     */
    public final void setLanguages(@NonNull final List<String> languagesParam) {
        this.languages = languagesParam;
    }
     ...
     */
    public final void setCreatedBy(@NonNull final List<CreatedBy> createdByParam) {
        this.createdBy = createdByParam;
    }
     ...
     */
    public final void setOriginCountry(@NonNull final List<String> originCountryParam) {
        this.originCountry = originCountryParam;
    }
     ...
     */
    public final void setEpisodeRunTime(@NonNull final List<String> episodeRunTimeParam) {
        this.episodeRunTime = episodeRunTimeParam;
    }
