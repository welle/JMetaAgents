...
public final class JTvrecommandationsResponse {
     ...
     * Empty Constructor.
     */
    public JTvrecommandationsResponse() {
    	// Nothing to do
    }
     ...
     */
    public JTvrecommandationsResponse(@Nullable final Integer pageParam, @Nullable final Integer totalPagesParam, @NonNull final List<Results> resultsParam, @Nullable final Integer totalResultsParam) {
        this.page = pageParam;
