...
public final class JTvepisodeimagesQuestion {
     ...
     * Empty Constructor.
     */
    public JTvepisodeimagesQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvepisodeimagesQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer episodeNumberParam, @Nullable final Integer seasonNumberParam) {
        this.tvId = tvIdParam;
