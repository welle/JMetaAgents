...
public final class JTvseasonvideosResponse {
     ...
     * Empty Constructor.
     */
    public JTvseasonvideosResponse() {
    	// Nothing to do
    }
     ...
     */
    public JTvseasonvideosResponse(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
