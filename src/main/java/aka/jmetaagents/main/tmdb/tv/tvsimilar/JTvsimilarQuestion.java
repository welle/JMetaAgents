...
public final class JTvsimilarQuestion {
     ...
     */
    public JTvsimilarQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam, @Nullable final String pageParam) {
        this.tvId = tvIdParam;
