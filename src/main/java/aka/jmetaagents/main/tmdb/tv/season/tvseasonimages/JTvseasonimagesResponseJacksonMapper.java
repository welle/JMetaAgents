 ...
 * @author Welle
 */ 
public final class JTvseasonimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvseasonimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
