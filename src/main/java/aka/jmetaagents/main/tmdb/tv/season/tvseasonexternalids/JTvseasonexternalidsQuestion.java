...
public final class JTvseasonexternalidsQuestion {
     ...
     * Empty Constructor.
     */
    public JTvseasonexternalidsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JTvseasonexternalidsQuestion(@Nullable final Integer tvIdParam, @Nullable final Integer seasonNumberParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
