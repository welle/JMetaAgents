...
public final class JTvcreditsQuestion {
     ...
     */
    public JTvcreditsQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
