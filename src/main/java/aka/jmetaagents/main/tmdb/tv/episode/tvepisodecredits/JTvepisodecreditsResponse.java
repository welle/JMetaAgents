...
import aka.jmetaagents.main.tmdb.tv.episode.tvepisodecredits.deserializers.DateYearMonthDayDashDeserializer;
...
public final class JTvepisodecreditsResponse {
     ...
     * Empty Constructor.
     */
    public JTvepisodecreditsResponse() {
    	// Nothing to do
    }
     ...
     */
    public final void setGuestStars(@NonNull final List<GuestStars> guestStarsParam) {
        this.guestStars = guestStarsParam;
    }
}
