 ...
 * @author Welle
 */ 
public final class JTvepisodevideosResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvepisodevideosResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodevideosResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodevideosResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
