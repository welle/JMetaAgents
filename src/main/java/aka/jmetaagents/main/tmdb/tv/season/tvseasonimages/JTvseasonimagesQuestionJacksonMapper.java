 ...
 * @author Welle
 */ 
public final class JTvseasonimagesQuestionJacksonMapper {
     ...
     * @return JTvseasonimagesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvseasonimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvseasonimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
