 ...
 * @author Welle
 */ 
public final class JTvcreditsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvcreditsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvcreditsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvcreditsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
