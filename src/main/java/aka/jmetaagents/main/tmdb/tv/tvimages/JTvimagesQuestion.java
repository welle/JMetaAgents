...
public final class JTvimagesQuestion {
     ...
     */
    public JTvimagesQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
