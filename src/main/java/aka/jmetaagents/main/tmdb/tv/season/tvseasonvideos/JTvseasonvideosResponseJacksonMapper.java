 ...
 * @author Welle
 */ 
public final class JTvseasonvideosResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JTvseasonvideosResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvseasonvideosResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvseasonvideosResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
