 ...
 * @author Welle
 */ 
public final class JTvepisodeexternalidsQuestionJacksonMapper {
     ...
     * @return JTvepisodeexternalidsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JTvepisodeexternalidsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JTvepisodeexternalidsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTvepisodeexternalidsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTvepisodeexternalidsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
