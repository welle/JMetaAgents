...
public final class JTvdetailsQuestion {
     ...
     */
    public JTvdetailsQuestion(@Nullable final Integer tvIdParam, @Nullable final String languageParam) {
        this.tvId = tvIdParam;
