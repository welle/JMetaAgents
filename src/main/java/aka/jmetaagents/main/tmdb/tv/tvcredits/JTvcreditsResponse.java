...
public final class JTvcreditsResponse {
     ...
     */
    public JTvcreditsResponse(@NonNull final List<Cast> castParam, @Nullable final Integer idParam, @NonNull final List<Crew> crewParam) {
        this.cast = castParam;
        this.id = idParam;
        this.crew = crewParam;
    }
