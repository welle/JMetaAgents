 ...
 * @author Welle
 */ 
public final class JCreditsdetailsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCreditsdetailsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCreditsdetailsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCreditsdetailsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
