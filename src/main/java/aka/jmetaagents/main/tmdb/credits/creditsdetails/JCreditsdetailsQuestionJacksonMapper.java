 ...
 * @author Welle
 */ 
public final class JCreditsdetailsQuestionJacksonMapper {
     ...
     * @return JCreditsdetailsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCreditsdetailsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCreditsdetailsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCreditsdetailsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCreditsdetailsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
