 ...
 * @author Welle
 */ 
public final class JCompaniesdetailsQuestionJacksonMapper {
     ...
     * @return JCompaniesdetailsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCompaniesdetailsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCompaniesdetailsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCompaniesdetailsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCompaniesdetailsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
