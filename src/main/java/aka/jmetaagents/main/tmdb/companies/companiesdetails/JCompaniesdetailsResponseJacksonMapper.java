 ...
 * @author Welle
 */ 
public final class JCompaniesdetailsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCompaniesdetailsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCompaniesdetailsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCompaniesdetailsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
