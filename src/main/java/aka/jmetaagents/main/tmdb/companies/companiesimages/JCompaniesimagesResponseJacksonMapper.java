 ...
 * @author Welle
 */ 
public final class JCompaniesimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCompaniesimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCompaniesimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCompaniesimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
