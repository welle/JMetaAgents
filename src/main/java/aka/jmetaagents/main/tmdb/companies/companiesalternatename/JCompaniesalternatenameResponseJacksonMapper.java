 ...
 * @author Welle
 */ 
public final class JCompaniesalternatenameResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCompaniesalternatenameResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCompaniesalternatenameResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCompaniesalternatenameResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
