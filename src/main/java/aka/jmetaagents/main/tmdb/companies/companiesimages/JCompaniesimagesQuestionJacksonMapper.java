 ...
 * @author Welle
 */ 
public final class JCompaniesimagesQuestionJacksonMapper {
     ...
     * @return JCompaniesimagesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCompaniesimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCompaniesimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCompaniesimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCompaniesimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
