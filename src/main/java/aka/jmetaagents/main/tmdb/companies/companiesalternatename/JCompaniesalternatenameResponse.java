...
public final class JCompaniesalternatenameResponse {
     ...
     * Empty Constructor.
     */
    public JCompaniesalternatenameResponse() {
    	// Nothing to do
    }
     ...
     */
    public JCompaniesalternatenameResponse(@Nullable final Integer idParam, @NonNull final List<Results> resultsParam) {
        this.id = idParam;
