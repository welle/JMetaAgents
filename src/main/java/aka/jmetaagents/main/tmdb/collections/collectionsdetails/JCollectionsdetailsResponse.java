...
public final class JCollectionsdetailsResponse {
     ...
     * Empty Constructor.
     */
    public JCollectionsdetailsResponse() {
    	// Nothing to do
    }
     ...
     */
    public JCollectionsdetailsResponse(@Nullable final String backdropPathParam, @Nullable final String overviewParam, @Nullable final String nameParam, @NonNull final List<Parts> partsParam, @Nullable final Integer idParam, @Nullable final String posterPathParam) {
     ...
     * @param partsParam
     */
    public final void setParts(@NonNull final List<Parts> partsParam) {
        this.parts = partsParam;
    }
