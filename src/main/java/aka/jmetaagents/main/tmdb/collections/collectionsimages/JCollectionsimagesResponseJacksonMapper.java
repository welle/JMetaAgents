 ...
 * @author Welle
 */ 
public final class JCollectionsimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCollectionsimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionsimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCollectionsimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
