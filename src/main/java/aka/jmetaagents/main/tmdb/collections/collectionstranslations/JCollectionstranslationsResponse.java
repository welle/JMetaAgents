...
public final class JCollectionstranslationsResponse {
     ...
     * Empty Constructor.
     */
    public JCollectionstranslationsResponse() {
    	// Nothing to do
    }
     ...
     */
    public JCollectionstranslationsResponse(@NonNull final List<Translations> translationsParam, @Nullable final Integer idParam) {
