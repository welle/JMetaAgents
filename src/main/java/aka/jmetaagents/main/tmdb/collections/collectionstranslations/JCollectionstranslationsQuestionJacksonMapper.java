 ...
 * @author Welle
 */ 
public final class JCollectionstranslationsQuestionJacksonMapper {
     ...
     * @return JCollectionstranslationsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCollectionstranslationsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCollectionstranslationsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionstranslationsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCollectionstranslationsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
