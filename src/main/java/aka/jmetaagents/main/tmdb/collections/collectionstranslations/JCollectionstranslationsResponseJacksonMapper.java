 ...
 * @author Welle
 */ 
public final class JCollectionstranslationsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JCollectionstranslationsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionstranslationsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCollectionstranslationsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
