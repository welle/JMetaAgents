...
public final class JCollectionsdetailsQuestion {
     ...
     * Empty Constructor.
     */
    public JCollectionsdetailsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JCollectionsdetailsQuestion(@Nullable final Integer collectionIdParam, @Nullable final String languageParam) {
