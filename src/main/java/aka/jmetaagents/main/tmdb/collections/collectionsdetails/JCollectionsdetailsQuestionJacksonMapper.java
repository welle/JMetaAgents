 ...
 * @author Welle
 */ 
public final class JCollectionsdetailsQuestionJacksonMapper {
     ...
     * @return JCollectionsdetailsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCollectionsdetailsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCollectionsdetailsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionsdetailsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCollectionsdetailsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
