 ...
 * @author Welle
 */ 
public final class JCollectionsimagesQuestionJacksonMapper {
     ...
     * @return JCollectionsimagesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JCollectionsimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JCollectionsimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionsimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JCollectionsimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
