...
public final class JCollectionsimagesQuestion {
     ...
     * Empty Constructor.
     */
    public JCollectionsimagesQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JCollectionsimagesQuestion(@Nullable final Integer collectionIdParam, @Nullable final String languageParam) {
