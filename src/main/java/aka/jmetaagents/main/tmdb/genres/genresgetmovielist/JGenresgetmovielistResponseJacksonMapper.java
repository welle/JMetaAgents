 ...
 * @author Welle
 */ 
public final class JGenresgetmovielistResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JGenresgetmovielistResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGenresgetmovielistResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGenresgetmovielistResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
