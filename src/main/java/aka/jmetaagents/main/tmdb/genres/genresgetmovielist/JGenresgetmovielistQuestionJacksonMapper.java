 ...
 * @author Welle
 */ 
public final class JGenresgetmovielistQuestionJacksonMapper {
     ...
     * @return JGenresgetmovielistQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JGenresgetmovielistQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JGenresgetmovielistQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGenresgetmovielistQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGenresgetmovielistQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
