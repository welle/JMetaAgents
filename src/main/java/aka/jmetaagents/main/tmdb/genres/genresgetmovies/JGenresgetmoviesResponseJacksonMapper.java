 ...
 * @author Welle
 */ 
public final class JGenresgetmoviesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JGenresgetmoviesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGenresgetmoviesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGenresgetmoviesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
