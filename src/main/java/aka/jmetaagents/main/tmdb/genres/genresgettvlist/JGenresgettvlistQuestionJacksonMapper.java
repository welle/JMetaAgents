 ...
 * @author Welle
 */ 
public final class JGenresgettvlistQuestionJacksonMapper {
     ...
     * @return JGenresgettvlistQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JGenresgettvlistQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JGenresgettvlistQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGenresgettvlistQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGenresgettvlistQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
