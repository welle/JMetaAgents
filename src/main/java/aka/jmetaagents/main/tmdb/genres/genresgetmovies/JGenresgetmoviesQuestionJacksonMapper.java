 ...
 * @author Welle
 */ 
public final class JGenresgetmoviesQuestionJacksonMapper {
     ...
     * @return JGenresgetmoviesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JGenresgetmoviesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JGenresgetmoviesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGenresgetmoviesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGenresgetmoviesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
