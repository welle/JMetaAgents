 ...
 * @author Welle
 */ 
public final class JFindbyimdbidResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JFindbyimdbidResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JFindbyimdbidResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JFindbyimdbidResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
