 ...
 * @author Welle
 */ 
public final class JFindbytvdbidResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JFindbytvdbidResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JFindbytvdbidResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JFindbytvdbidResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
