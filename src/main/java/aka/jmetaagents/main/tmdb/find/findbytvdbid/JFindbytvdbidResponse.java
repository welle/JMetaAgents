...
public final class JFindbytvdbidResponse {
     ...
     */
    public JFindbytvdbidResponse(@NonNull final List<String> personResultsParam, @NonNull final List<MovieResults> movieResultsParam, @NonNull final List<String> tvResultsParam, @NonNull final List<String> tvEpisodeResultsParam, @NonNull final List<String> tvSeasonResultsParam) {
