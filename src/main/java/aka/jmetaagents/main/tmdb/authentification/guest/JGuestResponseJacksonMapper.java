 ...
 * @author Welle
 */ 
public final class JGuestResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JGuestResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JGuestResponse result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JGuestResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JGuestResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
