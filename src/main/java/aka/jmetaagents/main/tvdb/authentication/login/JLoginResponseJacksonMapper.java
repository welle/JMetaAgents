 ...
 * @author Welle
 */ 
public final class JLoginResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JLoginResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JLoginResponse result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JLoginResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JLoginResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
