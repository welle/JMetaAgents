 ...
 * @author Welle
 */ 
public final class JLoginQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JLoginQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JLoginQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JLoginQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JLoginQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
