 ...
 * @author Welle
 */ 
public final class JSeriesidQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
