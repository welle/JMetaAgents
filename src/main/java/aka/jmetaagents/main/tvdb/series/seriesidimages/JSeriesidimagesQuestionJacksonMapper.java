 ...
 * @author Welle
 */ 
public final class JSeriesidimagesQuestionJacksonMapper {
     ...
     * @return JSeriesidimagesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidimagesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidimagesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidimagesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidimagesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
