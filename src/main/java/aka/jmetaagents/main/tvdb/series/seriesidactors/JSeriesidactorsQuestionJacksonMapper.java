 ...
 * @author Welle
 */ 
public final class JSeriesidactorsQuestionJacksonMapper {
     ...
     * @return JSeriesidactorsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidactorsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidactorsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidactorsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidactorsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
