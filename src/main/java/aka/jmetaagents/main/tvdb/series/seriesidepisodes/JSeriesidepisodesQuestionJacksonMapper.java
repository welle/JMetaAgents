 ...
 * @author Welle
 */ 
public final class JSeriesidepisodesQuestionJacksonMapper {
     ...
     * @return JSeriesidepisodesQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidepisodesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidepisodesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
