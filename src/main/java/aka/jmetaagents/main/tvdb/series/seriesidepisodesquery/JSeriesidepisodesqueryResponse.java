...
public final class JSeriesidepisodesqueryResponse {
     ...
     * Empty Constructor.
     */
    public JSeriesidepisodesqueryResponse() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesidepisodesqueryResponse(@NonNull final List<Data> dataParam, @Nullable final Links linksParam, @Nullable final Errors errorsParam) {
        this.data = dataParam;
