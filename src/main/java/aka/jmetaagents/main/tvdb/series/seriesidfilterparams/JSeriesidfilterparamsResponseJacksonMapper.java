 ...
 * @author Welle
 */ 
public final class JSeriesidfilterparamsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidfilterparamsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidfilterparamsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidfilterparamsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
