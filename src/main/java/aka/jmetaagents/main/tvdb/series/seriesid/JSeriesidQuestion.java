...
public final class JSeriesidQuestion {
     ...
     */
    public JSeriesidQuestion(@Nullable final Integer idParam, @Nullable final String acceptLanguageParam) {
        this.id = idParam;
