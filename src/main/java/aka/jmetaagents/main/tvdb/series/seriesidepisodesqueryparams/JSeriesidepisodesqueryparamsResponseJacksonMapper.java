 ...
 * @author Welle
 */ 
public final class JSeriesidepisodesqueryparamsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidepisodesqueryparamsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodesqueryparamsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodesqueryparamsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
