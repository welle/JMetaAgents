...
public final class JSeriesidimagesqueryparamsQuestion {
     ...
     * Empty Constructor.
     */
    public JSeriesidimagesqueryparamsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesidimagesqueryparamsQuestion(@Nullable final Integer idParam, @Nullable final String acceptLanguageParam) {
        this.id = idParam;
