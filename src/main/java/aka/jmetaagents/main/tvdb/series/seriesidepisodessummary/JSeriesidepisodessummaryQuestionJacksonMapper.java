 ...
 * @author Welle
 */ 
public final class JSeriesidepisodessummaryQuestionJacksonMapper {
     ...
     * @return JSeriesidepisodessummaryQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidepisodessummaryQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidepisodessummaryQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodessummaryQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodessummaryQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
