 ...
 * @author Welle
 */ 
public final class JSeriesidimagesqueryQuestionJacksonMapper {
     ...
     * @return JSeriesidimagesqueryQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidimagesqueryQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidimagesqueryQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidimagesqueryQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidimagesqueryQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
