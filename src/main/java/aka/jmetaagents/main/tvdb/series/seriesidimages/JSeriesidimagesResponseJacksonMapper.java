 ...
 * @author Welle
 */ 
public final class JSeriesidimagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidimagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidimagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidimagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
