...
public final class JSeriesidimagesQuestion {
     ...
     * Empty Constructor.
     */
    public JSeriesidimagesQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesidimagesQuestion(@Nullable final Integer idParam, @Nullable final String acceptLanguageParam) {
        this.id = idParam;
