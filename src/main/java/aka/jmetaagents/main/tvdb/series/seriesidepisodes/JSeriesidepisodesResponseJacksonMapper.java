 ...
 * @author Welle
 */ 
public final class JSeriesidepisodesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidepisodesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
