 ...
 * @author Welle
 */ 
public final class JSeriesidfilterResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidfilterResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidfilterResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidfilterResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
