 ...
 * @author Welle
 */ 
public final class JSeriesidepisodesqueryQuestionJacksonMapper {
     ...
     * @return JSeriesidepisodesqueryQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidepisodesqueryQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidepisodesqueryQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodesqueryQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodesqueryQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
