 ...
 * @author Welle
 */ 
public final class JSeriesidfilterparamsQuestionJacksonMapper {
     ...
     * @return JSeriesidfilterparamsQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidfilterparamsQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidfilterparamsQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidfilterparamsQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidfilterparamsQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
