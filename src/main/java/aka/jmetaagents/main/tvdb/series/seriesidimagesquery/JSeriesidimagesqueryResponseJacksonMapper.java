 ...
 * @author Welle
 */ 
public final class JSeriesidimagesqueryResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidimagesqueryResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidimagesqueryResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidimagesqueryResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
