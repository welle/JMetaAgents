...
public final class JSeriesidfilterparamsQuestion {
     ...
     * Empty Constructor.
     */
    public JSeriesidfilterparamsQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesidfilterparamsQuestion(@Nullable final Integer idParam, @Nullable final String acceptLanguageParam) {
        this.id = idParam;
