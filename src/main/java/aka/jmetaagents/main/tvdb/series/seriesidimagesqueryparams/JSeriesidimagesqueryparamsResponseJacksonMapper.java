 ...
 * @author Welle
 */ 
public final class JSeriesidimagesqueryparamsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidimagesqueryparamsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidimagesqueryparamsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidimagesqueryparamsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
