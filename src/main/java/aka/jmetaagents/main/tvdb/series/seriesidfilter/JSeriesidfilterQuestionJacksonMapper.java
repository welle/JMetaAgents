 ...
 * @author Welle
 */ 
public final class JSeriesidfilterQuestionJacksonMapper {
     ...
     * @return JSeriesidfilterQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesidfilterQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesidfilterQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidfilterQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidfilterQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
