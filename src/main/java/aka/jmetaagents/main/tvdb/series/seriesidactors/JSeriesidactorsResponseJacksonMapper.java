 ...
 * @author Welle
 */ 
public final class JSeriesidactorsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidactorsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidactorsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidactorsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
