...
public final class JSeriesidimagesqueryResponse {
     ...
     * Empty Constructor.
     */
    public JSeriesidimagesqueryResponse() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesidimagesqueryResponse(@NonNull final List<Data> dataParam, @Nullable final Errors errorsParam) {
        this.data = dataParam;
