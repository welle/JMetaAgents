 ...
 * @author Welle
 */ 
public final class JSeriesidepisodesqueryResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesidepisodesqueryResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesidepisodesqueryResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesidepisodesqueryResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
