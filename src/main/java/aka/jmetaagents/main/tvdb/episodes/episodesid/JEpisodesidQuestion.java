...
public final class JEpisodesidQuestion {
     ...
     */
    public JEpisodesidQuestion(@Nullable final Integer idParam, @Nullable final String acceptLanguageParam) {
        this.id = idParam;
