 ...
 * @author Welle
 */ 
public final class JEpisodesidQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JEpisodesidQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JEpisodesidQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodesidQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodesidQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
