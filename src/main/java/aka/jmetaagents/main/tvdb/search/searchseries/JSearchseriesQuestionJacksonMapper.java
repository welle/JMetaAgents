 ...
 * @author Welle
 */ 
public final class JSearchseriesQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JSearchseriesQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSearchseriesQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSearchseriesQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSearchseriesQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
