 ...
 * @author Welle
 */ 
public final class JSearchseriesparamsResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSearchseriesparamsResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSearchseriesparamsResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSearchseriesparamsResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
