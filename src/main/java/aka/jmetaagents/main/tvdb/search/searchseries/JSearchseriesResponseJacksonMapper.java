 ...
 * @author Welle
 */ 
public final class JSearchseriesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSearchseriesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSearchseriesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSearchseriesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
