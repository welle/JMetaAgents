...
public final class Data {
     ...
     */
    public Data(@Nullable final String englishNameParam, @Nullable final String nameParam, @Nullable final Integer idParam, @Nullable final String abbreviationParam) {
