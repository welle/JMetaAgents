 ...
 * @author Welle
 */ 
public final class JLanguagesResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JLanguagesResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JLanguagesResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JLanguagesResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
