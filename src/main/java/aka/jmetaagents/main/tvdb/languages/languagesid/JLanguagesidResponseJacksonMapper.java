 ...
 * @author Welle
 */ 
public final class JLanguagesidResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JLanguagesidResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JLanguagesidResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JLanguagesidResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
