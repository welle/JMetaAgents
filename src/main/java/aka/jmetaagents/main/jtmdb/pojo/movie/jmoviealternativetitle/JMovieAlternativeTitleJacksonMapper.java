 ...
 * @author Charlotte
 */
public final class JMovieAlternativeTitleJacksonMapper {
     ...
     */
    @Nullable
    public static JMovieAlternativeTitle readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMovieAlternativeTitle.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JMovieAlternativeTitle object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
