...
public final class BelongsToCollection {
     ...
     */
    public BelongsToCollection(@Nullable final String backdropPathParam, @Nullable final String nameParam, @Nullable final Integer idParam, @Nullable final String posterPathParam) {
