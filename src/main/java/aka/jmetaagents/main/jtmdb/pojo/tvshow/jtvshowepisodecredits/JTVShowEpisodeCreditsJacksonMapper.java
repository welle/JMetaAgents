 ...
 * @author Charlotte
 */ 
public final class JTVShowEpisodeCreditsJacksonMapper {
     ...
     */
	@Nullable
    public static JTVShowEpisodeCredits readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JTVShowEpisodeCredits.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JTVShowEpisodeCredits object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
