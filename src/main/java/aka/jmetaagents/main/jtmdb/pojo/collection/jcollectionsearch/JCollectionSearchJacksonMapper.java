 ...
 * @author Charlotte
 */
public final class JCollectionSearchJacksonMapper {
     ...
     */
    @Nullable
    public static JCollectionSearch readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JCollectionSearch.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JCollectionSearch object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
