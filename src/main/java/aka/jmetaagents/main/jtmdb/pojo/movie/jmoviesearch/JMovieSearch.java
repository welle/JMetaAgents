...
public final class JMovieSearch {
     ...
     */
    public JMovieSearch(@Nullable final Integer pageParam, @Nullable final Integer totalPagesParam, @NonNull final List<Results> resultsParam, @Nullable final Integer totalResultsParam) {
        this.page = pageParam;
