...
public final class Stills {
     ...
     */
    public Stills(@Nullable final Double aspectRatioParam, @Nullable final String filePathParam, @Nullable final Double voteAverageParam, @Nullable final Integer widthParam, @Nullable final String iso6391Param, @Nullable final Integer voteCountParam, @Nullable final Integer heightParam) {
