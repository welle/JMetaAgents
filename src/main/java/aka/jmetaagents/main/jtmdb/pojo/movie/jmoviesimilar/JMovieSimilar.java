...
public final class JMovieSimilar {
     ...
     */
    public JMovieSimilar(@Nullable final Integer pageParam, @Nullable final Integer totalPagesParam, @NonNull final List<Results> resultsParam, @Nullable final Integer totalResultsParam) {
        this.page = pageParam;
