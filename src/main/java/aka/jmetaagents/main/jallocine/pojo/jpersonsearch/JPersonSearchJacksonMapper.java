 ...
 * @author Charlotte
 */
public final class JPersonSearchJacksonMapper {
     ...
     */
    @Nullable
    public static JPersonSearch readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JPersonSearch.class);
        }
     ...
     */
    @Nullable
    public static String writeValue(@NonNull final JPersonSearch object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
