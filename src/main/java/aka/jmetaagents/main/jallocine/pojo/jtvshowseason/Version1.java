...
public final class Version1 {
     ...
     * @param originalParam Boolean
     * @param valueParam String
     */
    public Version1(@Nullable final Integer codeParam, @Nullable final Boolean originalParam, @Nullable final String valueParam) {
        this.code = codeParam;
     ...
     *
     * @return Boolean value of original
     */
    @Nullable
     ...
     * @param originalParam
     */
    public final void setOriginal(@Nullable final Boolean originalParam) {
        this.original = originalParam;
    }
