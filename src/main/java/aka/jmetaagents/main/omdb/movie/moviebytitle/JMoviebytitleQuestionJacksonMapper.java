 ...
 * @author Welle
 */ 
public final class JMoviebytitleQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviebytitleQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviebytitleQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviebytitleQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviebytitleQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
