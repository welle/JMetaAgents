 ...
 * @author Welle
 */ 
public final class JMoviebytitleResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviebytitleResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviebytitleResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviebytitleResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
