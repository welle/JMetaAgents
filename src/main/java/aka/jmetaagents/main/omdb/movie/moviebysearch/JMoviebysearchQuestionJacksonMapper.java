 ...
 * @author Welle
 */ 
public final class JMoviebysearchQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviebysearchQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JMoviebysearchQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviebysearchQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviebysearchQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
