 ...
 * @author Welle
 */ 
public final class JMoviebysearchResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviebysearchResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviebysearchResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviebysearchResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
