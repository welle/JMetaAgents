...
public final class JMoviebytitleQuestion {
     ...
     */
    public JMoviebytitleQuestion(@Nullable final Integer yParam, @Nullable final String titleParam) {
        this.y = yParam;
