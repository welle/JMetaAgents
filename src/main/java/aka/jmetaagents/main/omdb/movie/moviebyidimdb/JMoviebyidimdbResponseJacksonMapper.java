 ...
 * @author Welle
 */ 
public final class JMoviebyidimdbResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JMoviebyidimdbResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JMoviebyidimdbResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JMoviebyidimdbResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
