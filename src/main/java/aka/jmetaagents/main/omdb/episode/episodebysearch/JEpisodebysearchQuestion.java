...
public final class JEpisodebysearchQuestion {
     ...
     * Empty Constructor.
     */
    public JEpisodebysearchQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JEpisodebysearchQuestion(@Nullable final Integer yParam, @Nullable final Integer pageParam, @Nullable final String titleParam) {
        this.y = yParam;
        this.page = pageParam;
