 ...
 * @author Welle
 */ 
public final class JEpisodebytitleResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JEpisodebytitleResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebytitleResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebytitleResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
