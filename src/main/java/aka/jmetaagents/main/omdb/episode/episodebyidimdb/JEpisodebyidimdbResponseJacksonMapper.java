 ...
 * @author Welle
 */ 
public final class JEpisodebyidimdbResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JEpisodebyidimdbResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebyidimdbResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebyidimdbResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
