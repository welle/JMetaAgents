 ...
 * @author Welle
 */ 
public final class JEpisodebysearchQuestionJacksonMapper {
     ...
     * @return JEpisodebysearchQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JEpisodebysearchQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JEpisodebysearchQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebysearchQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebysearchQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
