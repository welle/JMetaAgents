 ...
 * @author Welle
 */ 
public final class JEpisodebytitleQuestionJacksonMapper {
     ...
     * @return JEpisodebytitleQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JEpisodebytitleQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JEpisodebytitleQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebytitleQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebytitleQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
