 ...
 * @author Welle
 */ 
public final class JEpisodebysearchResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JEpisodebysearchResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebysearchResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebysearchResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
