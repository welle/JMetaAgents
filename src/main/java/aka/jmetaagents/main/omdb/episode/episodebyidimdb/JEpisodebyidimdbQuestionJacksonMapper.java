 ...
 * @author Welle
 */ 
public final class JEpisodebyidimdbQuestionJacksonMapper {
     ...
     * @return JEpisodebyidimdbQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JEpisodebyidimdbQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JEpisodebyidimdbQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JEpisodebyidimdbQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JEpisodebyidimdbQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
