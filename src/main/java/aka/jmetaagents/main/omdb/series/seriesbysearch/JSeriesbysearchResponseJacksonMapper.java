 ...
 * @author Welle
 */ 
public final class JSeriesbysearchResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesbysearchResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbysearchResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbysearchResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
