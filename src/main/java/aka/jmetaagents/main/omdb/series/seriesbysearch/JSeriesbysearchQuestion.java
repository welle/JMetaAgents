...
public final class JSeriesbysearchQuestion {
     ...
     * Empty Constructor.
     */
    public JSeriesbysearchQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesbysearchQuestion(@Nullable final Integer yParam, @Nullable final Integer pageParam, @Nullable final String titleParam) {
        this.y = yParam;
        this.page = pageParam;
