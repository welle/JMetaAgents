 ...
 * @author Welle
 */ 
public final class JSeriesbyidimdbResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesbyidimdbResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbyidimdbResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbyidimdbResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
