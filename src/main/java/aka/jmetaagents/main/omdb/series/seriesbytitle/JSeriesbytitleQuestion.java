...
public final class JSeriesbytitleQuestion {
     ...
     */
    public JSeriesbytitleQuestion(@Nullable final Integer yParam, @Nullable final String titleParam) {
        this.y = yParam;
