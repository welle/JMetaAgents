 ...
 * @author Welle
 */ 
public final class JSeriesbysearchQuestionJacksonMapper {
     ...
     * @return JSeriesbysearchQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesbysearchQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesbysearchQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbysearchQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbysearchQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
