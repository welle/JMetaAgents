 ...
 * @author Welle
 */ 
public final class JSeriesbyidimdbQuestionJacksonMapper {
     ...
     * @return JSeriesbyidimdbQuestion.
	 * @throws IOException
     ...
     */
	@Nullable
    public static JSeriesbyidimdbQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesbyidimdbQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbyidimdbQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbyidimdbQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
