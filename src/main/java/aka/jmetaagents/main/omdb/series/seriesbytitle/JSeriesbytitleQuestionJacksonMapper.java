 ...
 * @author Welle
 */ 
public final class JSeriesbytitleQuestionJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesbytitleQuestion readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        JSeriesbytitleQuestion result = null;
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbytitleQuestion.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbytitleQuestion object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
