 ...
 * @author Welle
 */ 
public final class JSeriesbytitleResponseJacksonMapper {
     ...
     */
	@Nullable
    public static JSeriesbytitleResponse readValue(@NonNull final String jsonString) throws JsonParseException, IOException {
        ...
        if (jsonString.trim().length() > 0) {
            ...
            result = objectMapper.readValue(jp, JSeriesbytitleResponse.class);
        }
	 ...
	 */
    @Nullable
    public static String writeValue(@NonNull final JSeriesbytitleResponse object) throws IOException {
        final ObjectMapper objectMapper = new ObjectMapper();
