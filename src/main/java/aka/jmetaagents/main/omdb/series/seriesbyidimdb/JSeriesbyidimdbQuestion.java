...
public final class JSeriesbyidimdbQuestion {
     ...
     * Empty Constructor.
     */
    public JSeriesbyidimdbQuestion() {
    	// Nothing to do
    }
     ...
     */
    public JSeriesbyidimdbQuestion(@Nullable final Integer imdbidParam, @Nullable final Integer yParam) {
