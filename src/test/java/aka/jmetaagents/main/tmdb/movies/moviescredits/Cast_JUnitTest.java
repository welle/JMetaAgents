...
public class Cast_JUnitTest {
    ...
    public void testGetCastId() {
        ...
        // act : run the test
        final Integer result = cast.getCastId();
    ...
    /**
     * setCastId with an new Cast.
     */
    @org.junit.Test
    public void testSetCastId() {
        // arrange : set up the test
        final Cast cast = mock(Cast.class);
        assert cast != null;
    ...
    /**
     * getDepartment with an new Cast.
     */
    @org.junit.Test
    public void testGetDepartment() {
        ...
        // act : run the test
        final String result = cast.getDepartment();
    ...
    /**
     * setDepartment with an new Cast.
     */
    @org.junit.Test
    public void testSetDepartment() {
        ...
        // TODO set proper expected value
        final String expectedValue = "X";
        cast.setDepartment(expectedValue);
        final String result = cast.getDepartment();
    ...
    public void testGetJob() {
        ...
        // act : run the test
        final String result = cast.getJob();
